...
<div class="collapse navbar-collapse menu--shylock"
	...
	<ul class="nav navbar-nav menu__list">
		...
		<%
            ...
            %>
		<li class="menu__item"><a class="menu__link" href="my-orders.jsp">My
				Orders</a></li>
		...
		<li class="menu__item"><a class="menu__link"
			href="customer-login.jsp">Customer Login</a></li>
		<li class="menu__item"><a class="menu__link"
			href="customer-register.jsp">Customer Register</a></li>
		<li class="menu__item"><a class="menu__link"
